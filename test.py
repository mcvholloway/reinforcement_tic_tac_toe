from strategy import Strategy, Trainer, HumanStrategyTTT, HumanStrategyC4
...
if __name__ == '__main__':
    ...
    trainer = Trainer(players=[strategy_2, strategy_1], current_state=starting_state, game=game,alpha=.1)
